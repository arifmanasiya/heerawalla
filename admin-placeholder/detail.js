        ...
        ? [
            ...
            },
            {
              ...
              rows: [
                ...
                ["Center shape", item.center_shape || item.centerShape],
                ["Center size", item.center_size || item.centerSize],
                ["Ring size", item.ring_size || item.ringSize || item.size],
                ["Wrist Size", item.wrist || item.wrist_size || item.wristSize],
                ["Chain Size", item.chain || item.chain_length || item.chainLength],  
                ["Earring Size", item.earring || item.earring_type || item.earringType],
                //["Size", item.size],
              ],
            },
            {
